    ...
    <View style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent} showsVerticalScrollIndicator={false}>
        ...
        <View style={[styles.redHeaderPill, styles.glowBlack]}>
          ...
          <Text style={[styles.headerTitleText, styles.boldSerifItalic]} numberOfLines={1}>
          ...
          <View key={item.id} style={[styles.materialCard, styles.glowBlack]}>
            ...
            <View style={styles.detailsRow}>
              <View style={styles.infoCol}>
                <Text style={[styles.mainTitle, styles.boldSerifItalic]}>{item.nom}</Text>
                
                <View style={styles.infoLine}>
                  <Text style={[styles.labelBlue, styles.boldSerifItalic]}>Marque :</Text> 
                  <Text style={[styles.valueTxt, styles.boldSerifItalic]}>{item.marque || "-"}</Text>
                </View>
                
                <View style={styles.infoLine}>
                  <Text style={[styles.labelBlue, styles.boldSerifItalic]}>Quantité :</Text> 
                  <Text style={[styles.valueTxt, styles.boldSerifItalic]}>{item.quantite}</Text>
                </View>
                
                <View style={styles.infoLine}>
                  <Text style={[styles.labelBlue, styles.boldSerifItalic]}>État :</Text> 
                  <Text style={[styles.statusVal, styles.boldSerifItalic, { color: item.etat.toLowerCase().includes('panne') ? '#8B0000' : '#059669' }]}>
                    {item.etat}
                  </Text>
                </View>
              </View>
        ...
        {inventory.length === 0 && (
          <View style={styles.emptyBox}>
            <Text style={[styles.emptyText, styles.boldSerifItalic]}>Aucun matériel enregistré.</Text>
          </View>
        )}
      </ScrollView>
    </View>
