  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {bgImage
        ...
        : <View style={[StyleSheet.absoluteFill, { backgroundColor: '#FFE4E8' }]} />
      }
...
const styles = StyleSheet.create({
  ...
  bgOverlay:   { ...StyleSheet.absoluteFillObject, backgroundColor: 'rgba(255,228,232,0.55)' },
  root:        { flex: 1 },

  // Header
  headerPill: {
    backgroundColor: '#8B0000', marginHorizontal: 16, marginTop: 12, marginBottom: 14,
