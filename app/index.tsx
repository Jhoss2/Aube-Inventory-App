...
const styles = StyleSheet.create({
  ...
  // Home Styles
  const styles = StyleSheet.create({
  // --- TES STYLES CONSERVÉS ET CORRIGÉS ---
  headerRed: { 
    marginHorizontal: 12, 
    marginTop: 20, 
    height: 60, 
    backgroundColor: '#c0262b', 
    borderRadius: 30, 
    flexDirection: 'row', 
    alignItems: 'center', 
  ...
  searchContainer: { 
    marginHorizontal: 12, 
    marginTop: 70, // Corrigé de 7p à 70 pour l'espace équitable
    flexDirection: 'row', 
    alignItems: 'center' 
  },
  searchInput: { 
  ...
  blockSelector: { 
    marginHorizontal: 12, 
    marginTop: 70, // Ajusté pour l'équilibre entre recherche et image
  ...
  univSection: { 
    marginHorizontal: 12, 
    marginTop: 70, // Espace équitable final avant l'image
    alignItems: 'center' 
  },
  imageContainer: { 
    width: '100%', 
    ...
    // Ajout de la lueur rose pour l'effet "luisant"
    shadowColor: '#fceef5',
  ...
  titleBadgeUnder: { 
    ...
    paddingVertical: 12, 
    borderRadius: 15, 
    marginTop: 20, // Titre descendu sous l'image
    elevation: 5,
    borderWidth: 1,
    borderColor: '#fceef5',
  },
