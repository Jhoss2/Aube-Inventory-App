...
const styles = StyleSheet.create({
  ...
  sidebarDrawer: { width: '50%', height: '100%', backgroundColor: '#8B1A1A', padding: 24, paddingTop: 50 },
  ...
  // Home Styles
  headerRed: { marginHorizontal: 14, marginTop: 42, height: 55, backgroundColor: '#c0262b', borderRadius: 24, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20 },
  ...
  blockSelector: { marginHorizontal: 14, marginTop: 14, backgroundColor: '#263d7e', borderRadius: 24, padding: 6, maxHeight: 55 },
  blockButton: { backgroundColor: '#385598', paddingHorizontal: 20, paddingVertical: 7, borderRadius: 6, marginRight: 6 },
  blockButtonText: { color: 'white', fontSize: 10, fontWeight: 'bold' },
  univSection: { marginHorizontal: 12, marginTop: 20, alignItems: 'center' },
  imageContainer: { width: '100%', height: 500, borderRadius: 25, overflow: 'hidden', backgroundColor: '#4184f4' },
