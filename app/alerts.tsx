...
import { View, Text, TouchableOpacity, FlatList, StyleSheet, StatusBar, SafeAreaView, Platform, ImageBackground } from 'react-native';
...
export default function AlertsScreen() {
  ...
  const alertsBg  = (appData && appData.settings && appData.settings.alertsBg) || null;
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
      ...
      {alertsBg && (
        <ImageBackground source={{ uri: alertsBg }} style={StyleSheet.absoluteFill} resizeMode="cover" />
      )}
