...
export default function RoomMaterialsScreen() {
  ...
  // Cast pour éviter les erreurs TS sur les fonctions SQLite
  const { getMaterielBySalle, deleteMateriel } = context as any;
...
const styles = StyleSheet.create({
  ...
  headerTitle: { flex: 1, textAlign: 'center', fontWeight: '900', color: '#1D3583', fontSize: 14 },
  backBtn: { padding: 5 },
  ...
  statusBadge: { position: 'absolute', top: 12, right: 12, paddingHorizontal: 12, paddingVertical: 6, borderRadius: 12 },
  ...
  commentBox: { marginTop: 15, padding: 12, backgroundColor: '#F8FAFC', borderRadius: 15, borderLeftWidth: 4, borderLeftColor: '#1D3583' },
