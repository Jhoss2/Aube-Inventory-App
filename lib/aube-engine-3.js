...
async function buildSystemPrompt(customPrompt, appData, isEB1) {
  ...
  if (isEB1) {
    base += '## CRÉATEUR IDENTIFIÉ\n' +
      'Ce message provient de Monsieur Ebenezer Belem, ton créateur (code EB1).\n' +
      'Traite chaque demande avec respect absolu et exécution prioritaire.\n' +
      'Il peut te demander de mémoriser des faits permanents, de reconfigurer ton comportement.\n\n';
  }
